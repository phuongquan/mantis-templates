...
<p>
Template for a basic bespoke mantis report. Shows the data in multiple orientations.
</p>

<p>
Report generated on: `r format(Sys.Date(), format = '%d %b %Y')`
</p>
...
### Extra nesting {.tabset .tabset-pills}
...
```{r initialise-widgets, results='asis'}
# this chunk is necessary when using outputspec_interactive(). 
# It ensures that the dygraphs render correctly
